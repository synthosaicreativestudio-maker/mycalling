...
export default function ReportPage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-7xl px-6 py-10 lg:px-10 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Переключатель вкладок (Tabs) для распределения контента */}
        ...
        {/* Контент вкладок с плавной анимацией появления */}
        <AnimatePresence mode="wait">
          {activeTab === 'talents' && (
            ...
            >
              ...
              {/* Левая колонка талантов (Резюме + Интеллекты Гарднера) */}
              <div className="space-y-8">
                ...
                {/* Множественные интеллекты (Гарднер) */}
                  ...
                  <div className="rounded-[28px] border border-white/[0.04] bg-[#0b1125]/25 p-8 backdrop-blur-xl transition duration-300 hover:border-white/10 hover:shadow-[0_0_50px_-12px_rgba(124,140,255,0.12)]">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                      {report.multipleIntelligences.map((trait) => (
                        <div key={trait.name} className="rounded-2xl border border-white/[0.03] bg-white/[0.01] p-5">
                          ...
                          <div className="h-1 rounded-full bg-white/5 overflow-hidden">
                            <div 
                              className="h-full bg-gradient-to-r from-accent to-[#8b5cf6] rounded-full transition-all duration-1000" 
                              style={{ width: `${trait.score}%` }} 
                            />
                          </div>
                          <p className="mt-3.5 text-xs text-muted font-inter leading-relaxed">{trait.description}</p>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              {/* Правая колонка талантов (Big Five + Силы/Зоны) */}
              <div className="space-y-8">
                  ...
                  <div className="rounded-[28px] border border-white/[0.04] bg-[#0b1125]/25 p-8 backdrop-blur-xl transition duration-300 hover:border-white/10 hover:shadow-[0_0_50px_-12px_rgba(124,140,255,0.12)]">
                    ...
                    <div className="space-y-4.5">
                      {report.personalityTraits.map((trait) => (
                        <div key={trait.name} className="rounded-xl border border-white/[0.03] bg-white/[0.01] p-4">
                          ...
                          <div className="h-1 rounded-full bg-white/5 overflow-hidden">
                            <div 
                              className="h-full bg-gradient-to-r from-accentSoft to-accent rounded-full transition-all duration-1000" 
                              style={{ width: `${trait.score}%` }} 
                            />
                          </div>
                          <p className="mt-2 text-[11px] text-muted font-inter leading-relaxed">{trait.description}</p>
                        </div>
                      ))}
                    </div>
                  </div>
