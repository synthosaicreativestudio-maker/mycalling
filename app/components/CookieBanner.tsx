  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="flex flex-col items-center justify-between gap-4 rounded-[20px] bg-[#080C14]/90 p-5 shadow-[0_16px_40px_rgba(0,0,0,0.5)] backdrop-blur-md border border-[var(--accent-wash-20)] md:flex-row md:px-8 md:py-4">
            <p className="text-sm text-[var(--text-muted)] leading-relaxed max-w-3xl">
              ...
              <a href="/privacy" className="text-[var(--accent-sky)] hover:text-[var(--accent-brown)] hover:underline ml-1">Политике конфиденциальности</a>.
            </p>
            <button
