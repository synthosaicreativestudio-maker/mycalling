...
export function SpaceBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-50 h-full w-full overflow-hidden bg-[#050816]">
      <!-- Фоновый радиальный градиент для общей глубины -->
      ...
      >
        <defs>
          <!-- Мягкий неоновый градиент для левого верхнего свечения (Aurora) -->
          ...
          <!-- Мягкое свечение для движущихся точек -->
          ...
          <!-- Яркое свечение для центральной вспышки -->
        ...
        <!-- Декоративные мелкие фоновые звезды -->
        <g opacity="0.3">
        ...
        <g transform="translate(0, 0)">
          ...
          <ellipse cx="1150" cy="680" rx="380" ry="240" fill="none" stroke="url(#bgOrbitGrad)" stroke-width="1" stroke-dasharray="4 8" transform="rotate(25 1150 680)" opacity="0.7">
            <!-- Медленное вращение пунктирной орбиты -->
            <animateTransform
              attributeName="transform"
              type="rotate"
              from="25 1150 680"
          ...
          <!-- Диагональная линия-луч, пересекающая орбиты -->
          ...
          <!-- 3. Движущиеся по орбитам светящиеся точки (Планеты способностей) -->
          <!-- Точка на Орбите 1 -->
          ...
          <!-- Мелкая точка на Орбите 3 (Быстрая) -->
          ...
          <!-- 4. Яркая неоновая звезда/вспышка на пересечении орбит (справа внизу) -->
          <!-- Координаты пересечения примерно (1240, 595) -->
          <g transform="translate(1240, 595)">
            <!-- Фоновое свечение вспышки -->
