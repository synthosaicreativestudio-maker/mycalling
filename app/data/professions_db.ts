...
export const professionsDb: Profession[] = [
  ...
  },
  {
    ...
    skills: {
      hard: ['Adobe Photoshop/Illustrator/InDesign', 'Типографика и шрифты', 'Генеративные ИИ-инструменты (Midjourney/Firefly)', 'Айдентика и дизайн-системы'],
  ...
  // Добавлено по итогам исследования рынка 2026 (docs/industries_and_professions/07_market_trends_2026.md)
  {
    ...
    transferableTo: ['DevOps-инженер', 'Облачный архитектор безопасности', 'Аудитор ИИ-систем', 'Backend-разработчик']
  },
  {
    id: 'mlops-engineer',
    name: 'MLOps-инженер',
    ...
    bigFive: { traits: { Conscientiousness: 'high', Stability: 'high' } },
    subjects: ['Математика', 'Информатика', 'Русский язык'],
    summary: 'Отвечает за то, чтобы модели машинного обучения надёжно работали в реальных продуктах: развёртывание, мониторинг и обновление ИИ-систем.',
