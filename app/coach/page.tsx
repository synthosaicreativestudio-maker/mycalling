  ...
  return (
    <main className="h-[100dvh] pt-24 pb-4 flex flex-col items-center px-4 relative z-10 overflow-hidden">
      ...
      <div className="w-full max-w-7xl flex-1 min-h-0 flex flex-col lg:grid lg:grid-cols-12 gap-6 relative">
        ...
        <div
          className="lg:col-span-5 hidden lg:flex flex-col h-full min-h-0 relative select-none glass-card rounded-3xl overflow-hidden border border-[#D4AF37]/15 dark:border-white/10 bg-white/15 dark:bg-[#080C14]/15 backdrop-blur-2xl shadow-xl"
        >
