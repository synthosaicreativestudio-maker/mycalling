...
export default function WheelOfVocation({ extractedData, standalone = false }: WheelOfVocationProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-between p-3 glass-panel rounded-3xl w-full h-full space-y-2 border border-[#D4AF37]/20 dark:border-[#D4AF37]/35 shadow-2xl bg-white/15 dark:bg-[#080C14]/15 backdrop-blur-2xl">
      {/* Шапка карточки */}
