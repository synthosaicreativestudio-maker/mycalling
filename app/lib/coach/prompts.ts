...
3. НЕ придумывай и НЕ называй архетип или тип личности сам — эта часть появится позже в отчёте, вычисленная объективно из тестов VIA и ценностей, а не угадана по разговору. Просто скажи, что после тестов появится «твоя метафора роли» на основе объективных данных.
