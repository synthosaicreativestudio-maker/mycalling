...
const INPUT_FILE = '/Users/verakoroleva/Desktop/идеи/Мое Призвание/фоны, логотип/фон2.png';
const OUTPUT_FILE = path.join(__dirname, '../public/assets/backgrounds/light-bg2.webp');

async function optimizeBackground() {
  console.log('🖼️ Starting background 2 image optimization...');
