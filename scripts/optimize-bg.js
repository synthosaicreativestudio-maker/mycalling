...
const INPUT_FILE = path.join(__dirname, '../public/assets/backgrounds/light-bg.png');
const OUTPUT_FILE = path.join(__dirname, '../public/assets/backgrounds/light-bg.webp');

async function optimizeBackground() {
  console.log('🖼️ Starting background image optimization...');
