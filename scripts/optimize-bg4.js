...
const INPUT_FILE = '/Users/verakoroleva/Desktop/идеи/Мое Призвание/фоны, логотип/фон 4.png';
const OUTPUT_FILE = path.join(__dirname, '../public/assets/backgrounds/light-bg4.webp');

async function optimizeBackground() {
  console.log('🖼️ Starting background 4 image optimization...');
  ...
  try {
    ...
    console.log(`✅ Background 4 optimized successfully!`);
